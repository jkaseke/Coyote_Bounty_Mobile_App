            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    AppText {
                        ...
                        text: qsTr("Created: %1").arg(localeProperties.formatDate(surveyInfo.created, Locale.ShortFormat))
                        visible: false
                        color: textColor
                        wrapMode: Text.WrapAtWordBoundaryOrAnywhere
                    }
                    ...
                    AppText {
                        ...
                        text: qsTr("Last modified: %1").arg(localeProperties.formatDate(surveyInfo.modified, Locale.ShortFormat))
                        visible: false
                        color: textColor
                        wrapMode: Text.WrapAtWordBoundaryOrAnywhere
                    }
            ...
            Item {
                ...
                ScrollView {
                    ...
                    AppText {
                        ...
                        text: qsTr("%1").arg(surveyInfo.desc)
