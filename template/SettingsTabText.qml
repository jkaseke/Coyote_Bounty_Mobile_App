...
SettingsTab {
    title: qsTr("Text")
    description: qsTr("Scale the text size used in surveys")
    icon: Icons.icon("change-font-size")
...
/*
                RowLayout {
                    ...
                    AppButton {
                        ...
                        iconSource: "images/font.png"
                        textPointSize: 16

                        onClicked: {
                            var dialog = fontDialog.createObject(mainStackView);
                            dialog.open();
                        }
                        ...
                        Component {
                            ...
                            FontDialog {
                                currentFont.family: appSettings.fontFamily

                                onAccepted: {
                                    appSettings.fontFamily = currentFont.family;
                                }
                            }
                        }
                    }
